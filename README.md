...
El backend ya está configurado en el archivo `examen-backend/.env` para usar las siguientes credenciales de base de datos. Si tu entorno local es diferente, debes modificarlas en dicho archivo:
...
- Asegúrate de tener los puertos `3000` (Backend) y `4200` (Frontend) libres en tu máquina para evitar conflictos al levantar los servicios completos.
